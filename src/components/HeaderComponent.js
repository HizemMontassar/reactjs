...
import { Form, FormGroup, Label, Input, Navbar, NavbarBrand, Nav, NavbarToggler, Collapse, NavItem, Jumbotron, Button, Modal, ModalHeader, ModalBody } from 'reactstrap';
                     ...
                     <Nav navbar>
                        ...
                        <NavItem>
                            <NavLink className="nav-link" to="/contactus">
                                <span className="fa fa-contact fa-lg"> Contact Us</span>
                            </NavLink>
                        </NavItem>
                     </Nav>
                     <Nav className="ml-auto">
                        <NavItem>
                            <Button outline onClick={this.toggleModal}>
                                <span className="fa fa-sigh-in fa-lg">Login</span>
                            </Button>
                        </NavItem>
                     </Nav>
                     </Collapse>
